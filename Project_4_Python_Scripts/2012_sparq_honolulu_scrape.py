...
with open('2012_sparq_honolulu.csv', 'wb') as f:
    ...
    for i in range(1, 11):
        query = {'page': i}
        r = requests.get('http://espn.go.com/high-school/football/events/nike-sparq-combines/2012/honolulu/results/_/id/96',
                      params = query)
