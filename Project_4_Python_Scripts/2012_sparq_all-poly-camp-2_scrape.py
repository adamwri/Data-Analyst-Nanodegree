...
with open('2012_sparq_all-poly-camp-2.csv', 'wb') as f:
    ...
    for i in range(1, 3):
        query = {'page': i}
        r = requests.get('http://espn.go.com/high-school/football/events/nike-sparq-combines/2012/all-poly-camp-2/results/_/id/112',
                      params = query)
