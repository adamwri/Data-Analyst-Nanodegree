...
with open('2012_sparq_all-poly-camp.csv', 'wb') as f:
    ...
    for i in range(1, 2):
        query = {'page': i}
        r = requests.get('http://espn.go.com/high-school/football/events/nike-sparq-combines/2012/all-poly-camp/results/_/id/111',
                      params = query)
