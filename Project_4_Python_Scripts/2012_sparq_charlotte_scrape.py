...
with open('2012_sparq_charlotte.csv', 'wb') as f:
    ...
    for i in range(1, 28):
        query = {'page': i}
        r = requests.get('http://espn.go.com/high-school/football/events/nike-sparq-combines/2012/charlotte/results/_/id/102',
                      params = query)
