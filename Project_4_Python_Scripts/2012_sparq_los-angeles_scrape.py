...
with open('2012_sparq_los-angeles.csv', 'wb') as f:
    ...
    for i in range(1, 27):
        query = {'page': i}
        r = requests.get('http://espn.go.com/high-school/football/events/nike-sparq-combines/2012/los-angeles/results/_/id/106',
                      params = query)
