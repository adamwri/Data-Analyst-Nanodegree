...
with open('2012_sparq_new-york-city.csv', 'wb') as f:
    ...
    for i in range(1, 20):
        query = {'page': i}
        r = requests.get('http://espn.go.com/high-school/football/events/nike-sparq-combines/2012/new-york-city/results/_/id/109',
                      params = query)
