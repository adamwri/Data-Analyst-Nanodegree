...
with open('2012_sparq_national.csv', 'wb') as f:
    ...
    for i in range(1, 2):
        query = {'page': i}
        r = requests.get('http://espn.go.com/high-school/football/events/nike-sparq-combines/2012/sparq-rating-national-championship/results/_/id/114',
                      params = query)
