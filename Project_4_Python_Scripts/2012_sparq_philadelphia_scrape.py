...
with open('2012_sparq_philadelphia.csv', 'wb') as f:
    ...
    for i in range(1, 25):
        query = {'page': i}
        r = requests.get('http://espn.go.com/high-school/football/events/nike-sparq-combines/2012/philadelphia/results/_/id/97',
                      params = query)
